...
from .views import homeView, CursoListBusquedaView, CursoCreateView, CursoUpdateView, CursoDeleteView, CursoDetailView, \
    AlcanceCreateView, AlcanceUpdateView, AlcanceDeleteView, RecomendacionCreateView, RecomendacionUpdateView, \
    RecomendacionDeleteView, CapituloUpdateView, CapituloDeleteView, CapituloCreateView, TemaCreateView, TemaUpdateView, \
    TemaDeleteView, DetalleCreateView, DetalleUpdateView, DetalleDeleteView
...
visitante_patterns = ([
                          ...
                          path('editar_recomendacion/<int:pk>/', RecomendacionUpdateView.as_view(),
                               name='editar_recomendacion'),
                          path('borrar_recomendacion/<int:pk>/', RecomendacionDeleteView.as_view(),
                               name='borrar_recomendacion'),
